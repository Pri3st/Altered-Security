...
- With the NT hash of `DCORP-MGMT$` craft a TGS for `cifs/dcorp-mgmt.dollarcorp.moneycorp.local` to be able to dump hashes like in [[1. CRTP/3. Linux Tools/dollarcorp.moneycorp.local/3. Domain Domination/Path 8 - RBCD|Path 8 - RBCD]]
