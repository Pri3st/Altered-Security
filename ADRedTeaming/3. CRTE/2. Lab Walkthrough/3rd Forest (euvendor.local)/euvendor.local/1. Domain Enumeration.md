- We discovered from [[3. CRTE/2. Lab Walkthrough/1st Forest (techcorp.local)/1. us.techcorp.local/1. Domain Enumeration|1. Domain Enumeration]] and [[3. CRTE/2. Lab Walkthrough/2nd Forest (eu.local)/eu.local/1. Domain Enumeration|1. Domain Enumeration]] that the `eu.local` Forest has a Bidirectional Forest Trust with `euvendor.local`.
